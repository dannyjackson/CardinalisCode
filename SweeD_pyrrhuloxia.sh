...
bcftools view -s 'PYRR003,PYRR004,PYRR006,PYRR007,PYRR009,PYRR011' /scratch/dnjacks4/cardinalis/to_b10k/b10k_filtered.recode.vcf.gz > /scratch/dnjacks4/cardinalis/to_b10k/sweed/urban_pyrr.vcf
...
cd pyrrhuloxia/urban

~/programs/sweed/SweeD -name pyrr_urban -input /scratch/dnjacks4/cardinalis/to_b10k/sweed/urban_pyrr.filtered.geno25.maf1.vcf -grid 100 -length 100000


bgzip /scratch/dnjacks4/cardinalis/to_b10k/sweed/urban_pyrr.filtered.geno25.maf1.vcf
tabix /scratch/dnjacks4/cardinalis/to_b10k/sweed/urban_pyrr.filtered.geno25.maf1.vcf.gz
zcat /scratch/dnjacks4/cardinalis/to_b10k/sweed/urban_pyrr.filtered.geno25.maf1.vcf.gz | grep -v "^#" | cut -f1 | sort | uniq > scaff_names_pyrr_urban.txt
...
grep 'Position' SweeD_Report.pyrr_urban | head -n 1 > SweeD_Report.header
awk '{print $0, "Scaffold"}' SweeD_Report.header | awk '{print $6,$1,$2,$3,$4,$5}' > SweeD_Report.pyrr_urban_manhattan_scaffnames
...
R
library(qqman)
sweed<-read.table("SweeD_Report.pyrr_urban_manhattan_scaffnames", header=TRUE)
...
scp dnjacks4@login.sol.rc.asu.edu:/scratch/dnjacks4/cardinalis/to_b10k/sweed/pyrrhuloxia/pyrr_urban_sweed.pdf .