...
bcftools view -s 'BM100619,BM100620,BM100621,BM103345,BM77856,BM77978'  /scratch/dnjacks4/cardinalis/to_b10k/b10k_filtered.recode.vcf.gz > /scratch/dnjacks4/cardinalis/to_b10k/sweed/rural_noca.vcf
...
cd northerncardinals/rural

~/programs/sweed/SweeD -name noca_rural -input /scratch/dnjacks4/cardinalis/to_b10k/sweed/rural_noca.filtered.geno25.maf1.vcf -grid 100 -length 100000
...
zcat /scratch/dnjacks4/cardinalis/to_b10k/sweed/rural_noca.filtered.geno25.maf1.vcf.gz | grep -v "^#" | cut -f1 | sort | uniq > scaff_names_noca_rural.txt
...
awk '{print $0, "Scaffold"}' SweeD_Report.header | awk '{print $6,$1,$2,$3,$4,$5}' > SweeD_Report.noca_rural_manhattan_scaffnames
...
scp dnjacks4@login.sol.rc.asu.edu:/scratch/dnjacks4/cardinalis/to_b10k/sweed/northerncardinals/noca_rural_sweed.pdf .